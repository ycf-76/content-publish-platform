...
from app.agents.core.harness.recovery.backoff import BackoffPolicy
from app.agents.core.harness.recovery.circuit_breaker import (
    CircuitBreaker,
    CircuitOpenError,
)
from app.agents.core.harness.recovery.strategies import RecoveryStrategy
...
class RecoveryLoop:
    ...
    def __init__(
        ...
        if not strategies:
            from app.agents.core.harness.recovery.strategies import RetryStrategy
